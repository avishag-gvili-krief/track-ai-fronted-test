...
//   const { filterShipmentsByFieldValue } = useWinwordContext();
...
//     const selectedInsight = insightOptions.find((insight) =>
//       selectedInsights.includes(insight.title)
//     );
    
//     if (selectedInsight && user?.activeCustomers) {
//       const customerCodes = user.activeCustomers.map((c) => c.customerNumber);
